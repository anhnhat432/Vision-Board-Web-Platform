...
export class MongoTwelveWeekImportRepository implements TwelveWeekImportRepository {
  ...
  async upsertPlan(data: ImportPlanData): Promise<UpsertResult<ImportedPlanEntity>> {
    ...
    const update = {
      ...
      lagMetric: data.lagMetric,
      milestones: data.milestones,
      successEvidence: data.successEvidence,
      reviewDay: data.reviewDay,
      week12Outcome: data.week12Outcome,
      weeklyActions: data.weeklyActions,
      successMetric: data.successMetric,
      dailyReminderTime: data.dailyReminderTime,
      tacticLoadPreference: data.tacticLoadPreference,
      preferredDays: data.preferredDays,
      personalConstraint: data.personalConstraint,
      reentryCount: data.reentryCount,
