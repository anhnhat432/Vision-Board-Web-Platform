...
/**
 * Handler xử lý mutation plan_snapshot_updated / plan_snapshot_upsert.
 *
 * Payload shape:
 * {
 *   clientPlanId: string;
 ...
 *   system?: { vision12Week?: string; startDate?: string; weeklyPlans?: WeekInput[] };
 *   weeks?: WeekInput[];
 * }
 *
 * WeekInput shape:
 ...
 *   milestone?: string;         // alias cho expectedOutput
 * }
 */
export class PlanSnapshotUpdatedHandler implements MutationHandlerStrategy {
  readonly mutationType: SyncMutationType = "plan_snapshot_updated";
