...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  {
    command: "/summary",
    description: "Tóm tắt kế hoạch 12 tuần và mục tiêu",
    promptText: "Tóm tắt toàn bộ kế hoạch 12 tuần và các mục tiêu hiện tại của tôi",
  },
  {
    command: "/stuck",
    description: "Tìm điểm kẹt và đề xuất hướng xử lý",
    promptText: "Hãy tìm điểm kẹt, task quá hạn và trở ngại của tôi, sau đó đề xuất hướng xử lý",
  },
  {
    command: "/suggest",
    description: "Gợi ý hành động dựa trên trang hiện tại",
    promptText: "Dựa vào trang hiện tại tôi đang xem, hãy đề xuất các hành động tiếp theo",
  },
