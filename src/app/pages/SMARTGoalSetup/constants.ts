...
export const FOCUS_AREA_EXAMPLES: Record<string, FocusAreaExample> = {
  ...
  Relationships: {
    ...
    measurable: [{ name: "Số buổi gặp gỡ, trò chuyện chất lượng/tuần", unit: "buổi/tuần", baseline: "0", target: "2" }],
    achievable: [{ hours: "3", skills: "Lắng nghe thấu cảm", resources: "Lịch cá nhân dành riêng cho bạn bè" }],
    relevant: [
  ...
  Family: {
    ...
    measurable: [{ name: "Số bữa tối sum họp không điện thoại/tuần", unit: "buổi/tuần", baseline: "0", target: "4" }],
    achievable: [{ hours: "5", skills: "Giao tiếp gắn kết gia đình", resources: "Không gian sinh hoạt chung ấm cúng" }],
    relevant: [
      {
