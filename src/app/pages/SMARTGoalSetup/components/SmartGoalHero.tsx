...
export function SmartGoalHero({
  ...
  return (
    <section
      ...
      className="rounded-[20px] border border-[rgba(23,21,15,0.08)] bg-white p-6 sm:p-7 flex flex-col md:flex-row md:items-center md:justify-between gap-5"
    ...
    >
      <div className="min-w-0 space-y-2">
        ...
        <h1
          ...
          className="text-[clamp(22px,2.4vw,30px)] font-extrabold leading-[1.08] tracking-[-0.02em] text-[#17150F]"
        ...
        <p className="text-[13px] leading-[1.5] text-[#7A6E5E]" data-testid="smart-goal-handoff-card">
          Lĩnh vực: <strong className="text-[#17150F] font-semibold">{focusAreaLabel}</strong> · Đo lường gợi ý:{" "}
          <strong className="text-[#17150F] font-semibold">{smartGoalStarter.metricName}</strong> · Lộ trình:{" "}
          <strong className="text-[#17150F] font-semibold">{smartGoalStarter.targetWeeks} tuần</strong>.
        </p>
      </div>

      <div className="flex shrink-0 flex-col items-center gap-1 bg-[#FAF8F3] border border-[rgba(23,21,15,0.08)] rounded-[14px] px-5 py-3">
        <span className="text-[9.5px] font-bold uppercase tracking-[0.12em] text-[#A8A296]">Tiến độ</span>
        <span className="text-2xl font-extrabold text-[#17150F] leading-none" style={{ fontFamily: "'Bricolage Grotesque', serif" }}>
          {completedCount}
