    ...
    <article className="mx-auto max-w-3xl space-y-section px-4 py-8 sm:px-6">
      ...
      <section className="surface-raised space-y-3 rounded-card border border-app-line bg-app-surface p-card-pad sm:p-7">
        ...
        <ul className="list-disc space-y-1.5 pl-5 text-sm leading-relaxed text-app-ink-soft">
          <li>
            <strong>Thông tin tài khoản:</strong> email, tên hiển thị mà bạn cung cấp khi đăng ký.
          </li>
          <li>
            <strong>Dữ liệu kế hoạch 12 tuần:</strong> mục tiêu, nhiệm vụ, nhật ký phản tư, và các đánh giá cân bằng
            cuộc sống mà bạn tạo trong ứng dụng.
          </li>
          <li>
            <strong>Dữ liệu thanh toán:</strong> thông tin đơn hàng, trạng thái giao dịch và trạng thái yêu cầu hoàn
            tiền. Khi bạn chủ động gửi yêu cầu hoàn tiền, chúng tôi lưu tài khoản ngân hàng nhận hoàn tiền để support xử
            lý chuyển khoản thủ công.
          </li>
          <li>
            <strong>Dữ liệu kỹ thuật:</strong> thông tin trình duyệt, thiết bị nhằm đảm bảo dịch vụ hoạt động ổn định.
          </li>
        </ul>
      </section>
      ...
      <section className="surface-raised space-y-3 rounded-card border border-app-line bg-app-surface p-card-pad sm:p-7">
        ...
        <ul className="list-disc space-y-1.5 pl-5 text-sm leading-relaxed text-app-ink-soft">
          ...
          <li>
            <strong>Nhà cung cấp thanh toán:</strong> chỉ khi bạn thực hiện giao dịch nâng cấp gói.
          </li>
          <li>
            <strong>Dịch vụ giám sát lỗi (Sentry):</strong> thu thập báo cáo lỗi kỹ thuật (không chứa nội dung cá nhân).
          </li>
        </ul>
      </section>
      ...
      <section className="surface-raised space-y-3 rounded-card border border-app-line bg-app-surface p-card-pad sm:p-7">
        ...
        <ul className="list-disc space-y-1.5 pl-5 text-sm leading-relaxed text-app-ink-soft">
          <li>
            <strong>Xuất dữ liệu:</strong> tải toàn bộ dữ liệu của bạn từ trang{" "}
            <Link
              to="/settings"
          ...
          <li>
            <strong>Xóa tài khoản:</strong> yêu cầu xóa toàn bộ dữ liệu tại trang{" "}
            <Link
              to="/settings"
              className="font-medium text-app-accent underline underline-offset-2 hover:text-app-ink"
            >
          ...
          <li>
            <strong>Chỉnh sửa thông tin:</strong> cập nhật tên hiển thị và email trong cài đặt tài khoản.
          </li>
        </ul>
      </section>
