...
describe("ReflectionJournal streak", () => {
  ...
  it("counts 3 days streak when entries on 3 consecutive days", () => {
  ...
  it("does not double-count entries at 23:59 and 00:01 of same calendar day", () => {
    vi.setSystemTime(new Date("2026-05-15T10:00:00+07:00"));
    seedReflections([
  ...
  it("counts entries at 23:59 day N and 00:01 day N+1 as 2 separate days", () => {
    vi.setSystemTime(new Date("2026-05-15T10:00:00+07:00"));
    seedReflections([
  ...
  it("returns 0 when no reflections", () => {
    vi.setSystemTime(new Date("2026-05-15T10:00:00+07:00"));
    seedReflections([]);
    renderJournal();
  ...
  it("includes today even if today has no entry yet (allows yesterday-start)", () => {
    vi.setSystemTime(new Date("2026-05-15T10:00:00+07:00"));
    seedReflections([
      { timestamp: "2026-05-14T20:00:00+07:00" },
