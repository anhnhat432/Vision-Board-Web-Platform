        ...
        <div className="space-y-6">
          ...
          <div className="surface-raised rounded-xl border border-app-line bg-app-surface p-5 md:p-6">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              <span className="inline-flex items-center rounded-full bg-app-accent-soft px-3 py-1 text-xs font-medium text-app-accent">
              ...
              {isCustomSelection && (
                <span className="inline-flex items-center rounded-full bg-app-warm-soft px-3 py-1 text-xs font-medium text-app-warm">
            ...
            <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_1fr]">
              ...
              <div className="surface-raised rounded-xl border border-app-line bg-app-surface p-5 md:p-6">
                ...
                <div className="mt-3">
                  ...
                  <h2 className="mt-3 text-2xl font-medium text-app-ink" style={{ fontFamily: "var(--font-serif)" }}>
                    {focusAreaLabel}
                  </h2>
                  <p className="mt-2 text-sm text-app-ink-soft">
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-app-ink">{smartGoalStarter.motivationReason}</p>
                  {selectedIntent && (
                    <div className="mt-3">
                      <span className="inline-flex items-center rounded-full border border-app-line bg-app-bg px-2.5 py-1 text-xs text-app-ink-soft">
                  ...
                  >
                    <div className="flex items-start gap-2">
                      ...
                      <div className="min-w-0 flex-1">
                        <p
                          className={`truncate text-sm font-medium ${isSelected ? "text-app-accent" : "text-app-ink"}`}
                        >
                          {getLifeAreaLabel(area.name)}
                        </p>
                        <p className={`mt-0.5 text-xs ${isSelected ? "text-app-accent" : "text-app-ink-muted"}`}>
                          {area.score}/10
                        </p>
                      </div>
              ...
              {intentOptions.map((option) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p
                      className={`text-xs leading-relaxed ${isSelected ? "text-app-accent" : "text-app-ink-soft"}`}
                    >
                      {option.description}
                    </p>
                  </button>
            ...
            {selectedIntent !== null && (
              <div className="mt-4 flex flex-wrap items-center gap-3">
                ...
                <button
                  ...
                  className="text-xs font-semibold text-app-ink-soft underline-offset-2 hover:text-app-ink hover:underline"
                >
                  Bỏ chọn
                </button>
              </div>
          ...
          <div className="surface-raised rounded-xl border border-app-line bg-app-surface p-5 md:p-6">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <h3 className="mt-1 text-base font-medium text-app-ink">Biến trọng tâm này thành mục tiêu SMART</h3>
                <p className="mt-1 text-xs text-app-ink-muted">Khoảng 4 phút</p>
              </div>
              <Button
                onClick={handleStartGoalSetup}
                className="inline-flex items-center gap-2 bg-app-accent px-5 py-2.5 text-sm font-medium text-white hover:bg-[#284f45]"
              >
                Tiếp → Viết mục tiêu
