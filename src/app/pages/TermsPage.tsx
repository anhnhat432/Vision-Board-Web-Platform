  ...
  return (
    <article className="mx-auto max-w-2xl space-y-8 py-4">
      <header className="space-y-3">
        ...
        <h1 className="text-2xl font-semibold tracking-tight text-app-ink">Điều khoản dịch vụ</h1>
        <p className="text-sm text-app-ink-muted">Cập nhật lần cuối: {LAST_UPDATED}</p>
      </header>

      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-app-ink">1. Phạm vi dịch vụ</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-app-ink">2. Tài khoản và nghĩa vụ người dùng</h2>
        <ul className="list-disc space-y-1.5 pl-5 text-sm leading-relaxed text-app-ink-soft">
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-app-ink">3. Quy tắc thanh toán</h2>
        <ul className="list-disc space-y-1.5 pl-5 text-sm leading-relaxed text-app-ink-soft">
          <li>
          ...
          <li>
            <strong>Hủy gói:</strong> bạn có thể hủy gói Plus bất kỳ lúc nào. Tính năng Plus vẫn hoạt động đến hết chu
            kỳ đã thanh toán.
          </li>
        </ul>
      </section>
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-app-ink">4. Giới hạn trách nhiệm</h2>
        <p className="text-sm leading-relaxed text-app-ink-soft">
          Dear Our Future được cung cấp theo nguyên tắc &ldquo;nguyên trạng&rdquo; (as-is). Chúng tôi nỗ lực duy trì
          dịch vụ ổn định nhưng không đảm bảo dịch vụ hoạt động liên tục không gián đoạn. Chúng tôi không chịu trách
          nhiệm cho:
        </p>
        <ul className="list-disc space-y-1.5 pl-5 text-sm leading-relaxed text-app-ink-soft">
          <li>Mất dữ liệu do lỗi thiết bị, trình duyệt, hoặc do người dùng xóa dữ liệu cục bộ.</li>
          <li>Gián đoạn dịch vụ do bảo trì hoặc sự cố kỹ thuật.</li>
          <li>
            Kết quả thực tế từ việc áp dụng kế hoạch 12 tuần — ứng dụng là công cụ hỗ trợ, không phải cam kết kết quả.
          </li>
        </ul>
      </section>

      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-app-ink">5. Thay đổi điều khoản</h2>
        <p className="text-sm leading-relaxed text-app-ink-soft">
          Chúng tôi có quyền cập nhật điều khoản dịch vụ này. Khi có thay đổi quan trọng, bạn sẽ được thông báo qua
          email hoặc thông báo trong ứng dụng. Việc tiếp tục sử dụng dịch vụ sau khi điều khoản được cập nhật đồng nghĩa
