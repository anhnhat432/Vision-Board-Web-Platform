  ...
  return (
    <div className="app-shell min-h-screen px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] w-full max-w-3xl items-center">
        <Card data-testid="real-mode-login-gate" className="w-full overflow-hidden border border-slate-200 bg-white/94 shadow-sm">
          <CardContent className="stack-stack p-6 text-center sm:p-8 lg:p-10">
            <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-[var(--r-tile)] bg-slate-950 text-white shadow-sm">
              <ShieldCheck className="h-5 w-5" aria-hidden="true" />
            </div>
            <div className="stack-tight">
              <p className="text-xs font-semibold uppercase tracking-[0.16em] text-slate-500">Tài khoản</p>
