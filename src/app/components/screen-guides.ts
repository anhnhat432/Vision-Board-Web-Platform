...
export const SCREEN_GUIDES = {
  ...
  aspirationalVision: {
    ...
    steps: [
      {
        label: "Viết bức tranh chung.",
        text: "Tóm tắt con người, công việc và nhịp sống bạn muốn có trong 3-5 năm tới.",
      },
      { label: "Chọn vài mảng chính.", text: "Chỉ cần điền những mảng thật sự quan trọng, không phải lấp đầy tất cả." },
      {
        label: "Dùng làm điểm neo.",
        text: "Sau khi lưu, quay lại Trang chính để chọn trọng tâm và kế hoạch gần nhất.",
      },
    ],
  ...
  visionBoardGallery: {
    ...
    steps: [
      ...
      {
        label: "Dọn thư viện.",
        text: "Chỉ xoá bảng khi bạn chắc chắn không cần giữ lại hình ảnh, câu nói và bố cục đó.",
      },
    ],
