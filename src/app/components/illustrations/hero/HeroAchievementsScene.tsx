...
export function HeroAchievementsScene({ className, ...rest }: AmbientIllustrationProps) {
  ...
  return (
    ...
    >
      ...
      <ellipse cx="400" cy="202" rx="314" ry="152" fill="currentColor" opacity="0.16" />
      <g opacity="0.46">
      ...
      <path d="M172 292C286 244 408 226 640 116" stroke={`url(#${ribbonId})`} strokeWidth="16" strokeLinecap="round" opacity="0.72" />
