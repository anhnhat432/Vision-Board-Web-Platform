...
export function BillingPlusIllustration({ className, ...rest }: AmbientIllustrationProps) {
  ...
  return (
    ...
    >
      ...
      <path
        d="M120 30L174 62L196 120L164 188L120 214L76 188L44 120L66 62L120 30Z"
        fill={`url(#${gradientId})`}
        stroke="currentColor"
        strokeOpacity="0.28"
        strokeWidth="2"
      />
      <path
        d="M120 30V214M66 62L164 188M174 62L76 188M44 120H196"
        stroke="white"
        strokeOpacity="0.22"
        strokeWidth="2"
      />
      ...
      <path
        d="M120 12V28M120 212V228M28 120H44M196 120H212M52 52L64 64M176 176L188 188"
        stroke="currentColor"
        strokeOpacity="0.42"
        strokeWidth="5"
        strokeLinecap="round"
