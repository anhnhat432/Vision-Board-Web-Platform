...
export function VisionMapIllustration({ className, ...rest }: AmbientIllustrationProps) {
  ...
  return (
    ...
    >
      ...
      <path d="M244 158C244 145 255 134 268 134C281 134 292 145 292 158C292 177 268 198 268 198C268 198 244 177 244 158Z" fill="#3B7565" opacity="0.72" />
      <circle cx="268" cy="158" r="7" fill="#ffffff" fillOpacity="0.76" />
      <path d="M96 62L104 76L120 79L108 91L111 107L96 100L82 107L84 91L72 79L88 76L96 62Z" fill="#4E8C7A" opacity="0.5" />
