...
function MiniLifeAreaIcon({ title, children, ...props }: IconProps & { title: string; children: ReactNode }) {
  return (
    <svg {...iconBase(props)}>
      <title>{title}</title>
      {children}
...
export function LifeAreaHealthIcon(props: IconProps) {
  return (
    <MiniLifeAreaIcon title="Sức khỏe" {...props}>
...
export function LifeAreaCareerIcon(props: IconProps) {
  return (
    <MiniLifeAreaIcon title="Sự nghiệp" {...props}>
...
export function LifeAreaFinanceIcon(props: IconProps) {
  return (
    <MiniLifeAreaIcon title="Tài chính" {...props}>
      <path d="M3 21h18" />
...
export function LifeAreaFamilyIcon(props: IconProps) {
  return (
    <MiniLifeAreaIcon title="Gia đình" {...props}>
...
export function LifeAreaLearningIcon(props: IconProps) {
  return (
    <MiniLifeAreaIcon title="Học tập" {...props}>
      <path d="M22 10v6" />
...
export function LifeAreaMindIcon(props: IconProps) {
  return (
    <MiniLifeAreaIcon title="Phát triển bản thân" {...props}>
      <path d="M7 20h10" />
...
export function LifeAreaFunIcon(props: IconProps) {
  return (
    <MiniLifeAreaIcon title="Giải trí" {...props}>
      <path d="M6 11h4" />
      <path d="M8 9v4" />
      <path d="M15 12h.01" />
      <path d="M18 10h.01" />
...
export function LifeAreaRelationshipIcon(props: IconProps) {
  return (
    <MiniLifeAreaIcon title="Mối quan hệ" {...props}>
