...
export function LifeAreaCareerIcon(props: AmbientIllustrationProps) {
  ...
  return (
    <AreaFrame gradientId={id} {...props}>
      ...
      <path
        d="M13 12V9h6v3M22 8l2-2M24 11h3"
        stroke="currentColor"
        strokeOpacity="0.62"
        strokeWidth="1.7"
        strokeLinecap="round"
...
export function LifeAreaFinanceIcon(props: AmbientIllustrationProps) {
  ...
  return (
    <AreaFrame gradientId={id} {...props}>
      ...
      <path
        d="M9 11v7c0 1.7 3.1 3 7 3s7-1.3 7-3v-7M9 15c0 1.7 3.1 3 7 3s7-1.3 7-3"
        stroke="currentColor"
        strokeOpacity="0.5"
        strokeWidth="1.6"
      />
...
export function LifeAreaMindIcon(props: AmbientIllustrationProps) {
  ...
  return (
    <AreaFrame gradientId={id} {...props}>
      ...
      <path
        d="M9 23h14M12 19l-4 4M20 19l4 4"
        stroke="currentColor"
        strokeOpacity="0.55"
        strokeWidth="1.8"
        strokeLinecap="round"
...
export function LifeAreaFunIcon(props: AmbientIllustrationProps) {
  ...
  return (
    <AreaFrame gradientId={id} {...props}>
      ...
      <path
        d="M16 18c0 4-4 4-4 7M16 18c0 4 4 4 4 7"
        stroke="currentColor"
        strokeOpacity="0.52"
        strokeWidth="1.7"
        strokeLinecap="round"
