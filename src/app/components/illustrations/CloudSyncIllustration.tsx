...
export function CloudSyncIllustration({ className, ...rest }: AmbientIllustrationProps) {
  ...
  return (
    ...
    >
      ...
      <path
        d="M95 158H230C253 158 272 140 272 118C272 97 256 80 235 78C226 49 200 32 170 38C146 43 128 59 120 80C96 80 76 98 76 121C76 141 83 158 95 158Z"
        fill={`url(#${gradientId})`}
        stroke="currentColor"
        strokeOpacity="0.28"
        strokeWidth="2"
      />
      <path
        d="M128 102C146 84 174 84 192 102M192 102H170M192 102V80M194 138C176 156 148 156 130 138M130 138H152M130 138V160"
        stroke="white"
        strokeOpacity="0.88"
        strokeWidth="8"
        strokeLinecap="round"
