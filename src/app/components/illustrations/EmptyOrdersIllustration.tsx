...
export function EmptyOrdersIllustration({ className, ...rest }: AmbientIllustrationProps) {
  ...
  return (
    ...
    >
      ...
      <path d="M84 108H236V190H84V108Z" fill={`url(#${gradientId})`} stroke="currentColor" strokeOpacity="0.24" strokeWidth="2" />
      <path d="M84 108L60 78H132L160 108H84ZM236 108L260 78H188L160 108H236Z" fill={`url(#${gradientId})`} opacity="0.66" />
      <path d="M160 108V190M112 108V190M208 108V190" stroke="white" strokeOpacity="0.42" strokeWidth="5" />
      <path d="M100 70C96 48 124 44 138 78M220 70C224 48 196 44 182 78" stroke="currentColor" strokeOpacity="0.34" strokeWidth="8" strokeLinecap="round" />
      <path d="M68 50L76 60M252 48L244 60M160 26V42M42 120H58M264 124H280" stroke="currentColor" strokeOpacity="0.36" strokeWidth="4" strokeLinecap="round" />
