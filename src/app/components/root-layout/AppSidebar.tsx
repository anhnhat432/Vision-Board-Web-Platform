...
export function AppSidebar({
  ...
  return (
    <aside
      ...
      className="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:z-30 lg:flex lg:w-[260px] lg:flex-col lg:border-r lg:border-[color:var(--border)] lg:bg-card"
    >
      <div className="flex h-16 shrink-0 items-center gap-2.5 border-b border-[color:var(--border)] px-5">
        ...
        >
          ...
          <div className="min-w-0">
            ...
            <span className="block truncate text-[11px] text-muted-foreground">12-tuần · Vision</span>
          </div>
        </button>
      </div>
      ...
      <nav className="flex-1 overflow-y-auto px-3 py-4" aria-label="Mục điều hướng">
        ...
        {secondaryNavItems.length > 0 ? (
          <>
            <p className="mt-5 px-2.5 pb-1.5 text-[10px] font-semibold uppercase tracking-[0.14em] text-muted-foreground">
              Thêm
            </p>
            <ul className="space-y-0.5">
      ...
      <div className="shrink-0 border-t border-[color:var(--border)] p-3">
        <div className="flex items-center gap-1.5 pb-2">
          <button
            ...
            className="flex h-9 flex-1 items-center justify-center gap-1.5 rounded-[var(--r-control)] border border-[color:var(--border)] bg-[color:var(--muted)] text-[12px] font-semibold text-muted-foreground transition-colors hover:bg-card hover:text-foreground"
          ...
          <button
            type="button"
            onClick={onOpenGuide}
            className="flex h-9 w-9 items-center justify-center rounded-[var(--r-control)] border border-[color:var(--border)] bg-[color:var(--muted)] text-muted-foreground transition-colors hover:bg-card hover:text-foreground"
        ...
        {user ? (
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="truncate text-[10.5px] text-muted-foreground">{user.planLabel}</p>
                </div>
            ...
            >
              ...
              <DropdownMenuItem
                ...
                className="flex cursor-pointer items-center gap-2 rounded-[calc(var(--r-control)-3px)] px-2.5 py-2 text-[13px] text-foreground"
              >
              ...
              <DropdownMenuItem
                ...
                className="flex cursor-pointer items-center gap-2 rounded-[calc(var(--r-control)-3px)] px-2.5 py-2 text-[13px] text-[color:var(--color-danger-fg)] focus:bg-[color:var(--color-danger-bg)]"
              >
          ...
          <div className="flex flex-col gap-1.5">
            <Button
              variant="default"
              size="sm"
              className="h-9 w-full rounded-[var(--r-control)] text-[12.5px]"
