  ...
  return (
    <>
      ...
      <Card
        ...
        className="border border-app-line bg-app-surface"
      >
        <CardHeader>
        ...
        <CardContent className="stack-section">
          <div className="rounded-lg border border-app-accent/20 bg-app-accent-soft p-5">
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div>
                <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-app-accent">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="stack-tight rounded-lg border border-app-line bg-app-bg p-4">
              <div>
                ...
                <p className="mt-1 text-[13px] text-app-ink-soft">Ngày bạn muốn khóa tuần và tự đánh giá lại nhịp.</p>
              </div>
            ...
            <div className="stack-tight rounded-lg border border-app-line bg-app-bg p-4">
              <div>
                ...
                <p className="mt-1 text-[13px] text-app-ink-soft">Khung giờ trên thiết bị để nhắc check-in và review.</p>
              </div>
              <Input
                id="reminder-time"
          ...
          <div className="rounded-lg border border-app-line bg-app-bg p-5">
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div>
                <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-app-ink-muted">Thứ tự việc lặp lại</p>
                <p className="mt-1 text-[13px] text-app-ink-soft">
              ...
              {system.leadIndicators.map((indicator, index) => (
                <div
                  ...
                  className={`grid gap-4 rounded-lg border p-5 md:grid-cols-[minmax(0,1fr)_150px_140px] ${
                    indicator.type === "optional" ? "border-app-warm/30 bg-app-warm-soft" : "border-app-accent/20 bg-app-surface"
                  }`}
                >
                  <div>
          ...
          <div className="grid gap-3 md:grid-cols-3">
            <div className="rounded-lg border border-app-ink bg-app-ink p-5 text-white">
              <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-white/70">Bắt đầu</p>
              <p className="mt-2 font-serif text-xl font-medium text-white">{formatCalendarDate(system.startDate)}</p>
            </div>
            <div className="rounded-lg border border-app-accent/20 bg-app-accent-soft p-5">
              <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-app-accent">Kết thúc</p>
            ...
            <div className="rounded-lg border border-app-warm/30 bg-app-warm-soft p-5">
              <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-app-warm">Số lần quay lại nhịp</p>
