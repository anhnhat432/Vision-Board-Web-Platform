      ...
      >
        ...
        <CardContent className="stack-section">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="stack-tight rounded-lg border border-app-line bg-app-bg p-4">
              <div>
                ...
                <p className="mt-1 text-[14px] text-app-ink-soft">Khung giờ trên thiết bị để nhắc check-in và review.</p>
              </div>
              <Input
                id="reminder-time"
          ...
          <div className="rounded-lg border border-app-line bg-app-bg p-5">
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div>
                <p className="text-[12px] font-semibold uppercase tracking-[0.16em] text-app-ink-muted">Thứ tự việc lặp lại</p>
                <p className="mt-1 text-[14px] text-app-ink-soft">
          ...
          <div className="grid gap-3 md:grid-cols-3">
            ...
            <div className="rounded-lg border border-app-warm/30 bg-app-warm-soft p-5">
              <p className="text-[12px] font-semibold uppercase tracking-[0.16em] text-app-warm">Số lần quay lại nhịp</p>
