...
className={cn(
          "bg-foreground text-background animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 w-fit max-w-xs origin-(--radix-tooltip-content-transform-origin) rounded-[calc(var(--r-control)-2px)] px-2.5 py-1.5 text-xs font-medium tracking-tight leading-snug text-balance shadow-[0_4px_12px_-4px_rgba(0,0,0,0.2)] motion-reduce:animate-none motion-reduce:!zoom-in-100",
          className,
        )}
        {...props}
      >
