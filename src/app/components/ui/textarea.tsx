...
function Textarea({ className, ...props }: React.ComponentProps<"textarea">) {
  return (
    <textarea
      data-slot="textarea"
      className={cn(
        "resize-none border-input placeholder:text-muted-foreground dark:bg-input/30 flex field-sizing-content min-h-20 w-full rounded-[24px] border bg-input-background px-4 py-3 text-sm leading-6 font-normal tracking-[-0.01em] shadow-[inset_0_1px_0_rgba(255,255,255,0.85),0_10px_24px_-20px_rgba(15,23,42,0.18)] transition-[color,box-shadow,border-color,height] outline-none disabled:cursor-not-allowed disabled:opacity-50",
