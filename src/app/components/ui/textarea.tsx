  ...
  ({ className, ...props }, ref) => {
    return (
      <textarea
        ...
        data-slot="textarea"
        className={cn(
          "border border-app-line placeholder:text-app-ink-muted text-app-ink flex min-h-24 max-h-60 w-full resize-y rounded-lg bg-app-surface px-3 py-2 text-base leading-6 font-normal tracking-tight shadow-[0_1px_2px_rgba(15,23,42,0.04)] transition-[color,box-shadow,border-color] outline-none md:text-sm",
