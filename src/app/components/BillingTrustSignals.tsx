  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <p className="text-[12px] font-medium uppercase tracking-[0.16em] text-app-accent">Tin cậy khi thanh toán</p>
          <h2 id={titleId} className="mt-1 text-[18px] font-medium text-app-ink">
            Chuyển khoản rõ ràng, hỗ trợ sau thanh toán.
          </h2>
        </div>
        <div
          className="flex items-center gap-2 rounded-full border border-app-line bg-app-bg px-3 py-2 text-[14px] font-medium text-app-accent"
          role="img"
          aria-label="Logo ngân hàng đại diện"
        >
          <span className="flex h-7 w-7 items-center justify-center rounded-full bg-app-accent text-[12px] text-white">VN</span>
          <span>Bank</span>
        </div>
      </div>
      ...
      <div className={`mt-4 grid gap-3 ${compact ? "" : "sm:grid-cols-2"}`}>
        <div className={itemClassName}>
          ...
          <p className="text-[14px] leading-6 text-app-ink-soft">Thanh toán qua chuyển khoản ngân hàng VN (Casso xác thực).</p>
        </div>
        <div className={itemClassName}>
          <MailCheck className="mt-0.5 h-5 w-5 shrink-0 text-app-accent" />
          <p className="text-[14px] leading-6 text-app-ink-soft">Biên nhận điện tử gửi qua email trong 1-2 phút.</p>
        </div>
        <div className={itemClassName}>
