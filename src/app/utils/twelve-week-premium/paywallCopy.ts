  ...
  switch (context) {
    case "template":
      return {
        ...
        description:
          "Đỡ mất thời gian tự dựng từ số 0. Chọn đúng khung cho kiểu mục tiêu của bạn rồi vào thẳng tuần đầu với việc cần làm, nhịp tải và điểm review đã được gợi ý sẵn.",
        recommendedPlan: "PLUS",
        bullets: [
          "5 khung chuyên biệt cho tìm việc, học sâu, sáng tạo, sức khỏe và mục tiêu cần tăng tốc",
          "Việc mẫu đủ rõ để sửa nhanh theo mục tiêu cụ thể của bạn",
    ...
    case "review":
      return {
        ...
        recommendedPlan: "PLUS",
        bullets: [
          "Đọc tín hiệu từ điểm, tiến độ và phần việc bị dồn lại trong tuần",
    ...
    case "reminder":
      return {
        ...
        bullets: [
          ...
          "Phân tích sâu hơn để thấy tuần nào đang hụt nhịp",
          "Toàn bộ lớp nâng cấp gộp trong một gói Plus duy nhất",
        ],
      };
    default:
      return {
        ...
        description:
          "Miễn phí đủ để bắt đầu một chu kỳ. Plus dành cho lúc bạn muốn bớt loay hoay lúc setup, giữ nhịp đều hơn trong tuần và review ra quyết định nhanh hơn.",
        recommendedPlan: "PLUS",
        bullets: [
          "Bắt đầu nhanh hơn với khung gợi ý thích nghi",
          "Giữ nhịp tốt hơn với nhắc việc và phân tích Plus",
