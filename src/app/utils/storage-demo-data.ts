  ...
  const goals: Goal[] = [
    {
      ...
      twelveWeekSystem: {
        ...
        leadIndicators: [
          ...
          { name: "Kết nối hoặc chủ động liên hệ", target: "3", unit: "lần/tuần" },
        ...
        successEvidence:
          "Portfolio đã công khai, CV hoàn chỉnh, có phản hồi từ nhà tuyển dụng và thói quen review hằng tuần được giữ đều.",
        reviewDay: "Sunday",
        ...
        weeklyActions: [
          ...
          "3 lần chủ động liên hệ chất lượng tới người trong ngành hoặc nhà tuyển dụng",
        ...
        weeklyPlans: [
          ...
          },
          {
            ...
            milestone: "Case study số 1 lên mạng",
            completed: true,
          },
          {
            weekNumber: 4,
            phaseName: "Xây nhịp / tăng tốc",
            focus: "Tăng nhịp chủ động liên hệ và mở case study số 2",
        ...
        dailyCheckIns: [
          {
            ...
            amountDone: "90 phút",
            outputCreated: "Hoàn thiện phần thử thách và giải pháp của case study số 2",
          ...
          },
          {
            ...
            didWorkToday: true,
            whichLeadIndicatorWorkedOn: "Kết nối hoặc chủ động nhắn tin",
            amountDone: "3 tin nhắn",
            outputCreated: "Gửi lời nhắn tới 2 nhà tuyển dụng và 1 lead thiết kế",
            obstacleOrIssue: "",
            dailySelfRating: 4,
            optionalNote: "",
          },
        ...
        weeklyReviews: [
          {
            ...
            biggestOutputThisWeek: "Hoàn thành dàn ý portfolio và CV mới",
          ...
          },
          {
            ...
            nextWeekPriority: "Đưa case study số 1 lên mạng",
            workloadDecision: "keep same",
            reviewCompleted: true,
            progressScore: 8,
            disciplineScore: 8,
          ...
          },
          {
            ...
            biggestOutputThisWeek: "Case study số 1 đã công khai và có phản hồi tốt",
            mainObstacle: "Chưa duy trì nhịp chủ động nhắn tin đều như dự kiến",
            nextWeekPriority: "Giữ nhịp chủ động nhắn tin 3 lần và mở case study số 2",
        ...
        scoreboard: [
          {
            weekNumber: 1,
            leadCompletionPercent: 75,
            mainMetricProgress: "2/20 đơn",
            outputDone: "Dàn ý portfolio + CV",
            reviewDone: true,
            weeklyScore: 78,
          },
          {
            weekNumber: 2,
            leadCompletionPercent: 80,
            mainMetricProgress: "4/20 đơn",
            outputDone: "CV + cấu trúc portfolio",
            reviewDone: true,
            weeklyScore: 80,
          },
          {
            weekNumber: 3,
            leadCompletionPercent: 85,
            mainMetricProgress: "7/20 đơn",
            outputDone: "Case study số 1",
            reviewDone: true,
            weeklyScore: 86,
          },
          {
