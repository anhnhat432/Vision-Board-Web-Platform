...
const ACCOUNT_BENEFITS = [
  "Dữ liệu hiện lưu trên trình duyệt này.",
  "Tài khoản là tùy chọn khi bạn muốn đồng bộ qua thiết bị khác.",
  "Hãy xuất dữ liệu nếu muốn giữ một bản sao trước khi đổi máy.",
];
    ...
    >
      <CardHeader>
        <CardTitle className="flex items-center gap-2 text-slate-950">
          ...
          Tài khoản là tùy chọn
        </CardTitle>
        <CardDescription className="text-slate-600">
          Bạn có thể dùng thử không cần đăng nhập. Đăng ký hoặc đăng nhập chỉ dành cho lớp lưu và đồng bộ sau này.
        </CardDescription>
      </CardHeader>
