        ...
        return (
          ...
          >
            ...
            <div className="flex items-start justify-between gap-3">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.12em] text-muted-foreground sm:text-xs sm:tracking-[0.16em]">
                  {item.label}
                </p>
            ...
            <p className="mt-1.5 text-[11px] text-muted-foreground sm:mt-2 sm:text-xs">{item.note}</p>
          </MotionStaggerItem>
        );
      })}
    </MotionStaggerList>
