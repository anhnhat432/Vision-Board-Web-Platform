...
export function QuoteBlock({
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-app-line/80 bg-app-surface/40 backdrop-blur-sm p-6 -rotate-[1.5deg] hover:rotate-0 hover:border-app-accent/20 transition-all duration-300 select-none shadow-[0_4px_24px_rgba(0,0,0,0.005)]">
      ...
      <figure className="relative z-10 text-center pt-2">
        <blockquote className="font-serif text-sm italic leading-relaxed text-app-ink-soft select-none">
          “{text}”
        </blockquote>
        <div className="mt-4 flex items-center justify-center gap-2">
          <div className="h-px w-6 bg-app-bg-subtle" />
