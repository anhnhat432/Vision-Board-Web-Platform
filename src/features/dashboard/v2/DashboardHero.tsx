...
export function DashboardHero({
  ...
  return (
    <section
      ...
      className="relative overflow-hidden rounded-[18px] border border-app-line bg-white dark:bg-neutral-950 p-6 md:p-8 grid gap-6 md:grid-cols-[minmax(0,1fr)_320px] md:items-center shadow-app-sm"
    >
      ...
      <div
        ...
        className="group/card relative z-10 rounded-[16px] border border-app-line bg-app-bg/50 dark:bg-neutral-900/50 p-5 shadow-app-sm transition-all duration-300"
      >
