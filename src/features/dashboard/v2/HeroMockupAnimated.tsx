...
export function HeroMockupAnimated({ previewData }: HeroMockupAnimatedProps) {
  ...
  return (
    <div className="appear-fade-up mx-auto w-full max-w-[440px] lg:mx-0 lg:max-w-md lg:[animation-delay:120ms]">
      ...
      <div className="relative rounded-2xl border border-app-line/80 bg-app-surface dark:bg-neutral-950 shadow-[0_24px_50px_-12px_rgba(47,93,80,0.12),0_8px_24px_-8px_rgba(0,0,0,0.04)] overflow-hidden transition-all duration-300">
        {/* Browser Header Bar */}
        <div className="flex items-center justify-between bg-app-bg-subtle/80 dark:bg-neutral-900/60 backdrop-blur-md px-4 py-3 border-b border-app-line/65 select-none">
          ...
          {/* Fake URL Bar */}
          <div className="bg-app-surface dark:bg-neutral-950 border border-app-line/60 rounded-md px-4 py-0.5 text-[10px] text-app-ink-muted/80 font-mono tracking-wide text-center w-48 truncate">
        ...
        <div className="relative p-6 bg-gradient-to-b from-app-surface/40 via-app-surface to-app-surface dark:from-neutral-950 dark:to-neutral-950 min-h-[340px]">
          ...
          <div className="grid grid-cols-1 xs:grid-cols-12 gap-5">
            ...
            <div className="xs:col-span-5 flex flex-col justify-between">
              <div>
                ...
                <div className="relative h-32 w-full select-none">
                  ...
                  <div className="absolute top-0 left-0 w-28 bg-app-surface dark:bg-neutral-900 p-2 rounded shadow-md border border-app-line/50 -rotate-[6deg] transition-transform hover:rotate-0 duration-300">
                  ...
                  <div className="absolute top-4 left-6 w-28 bg-app-surface dark:bg-neutral-900 p-2 rounded shadow-lg border border-app-line/60 rotate-[4deg] transition-transform hover:rotate-0 duration-300">
            ...
            <div className="xs:col-span-7 space-y-4">
              ...
              <div className="p-3.5 bg-app-bg-subtle dark:bg-neutral-900/40 border border-app-line/65 rounded-xl">
                ...
                <div className="mt-3.5 pt-2 border-t border-app-line/45">
                  ...
                  <div className="mt-1.5 h-1.5 w-full rounded-full bg-app-bg-subtle/70 dark:bg-neutral-800 overflow-hidden">
                    <div
              ...
              <div className="space-y-2.5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2.5 p-2 bg-app-bg-subtle/50 dark:bg-neutral-900/20 border border-app-line/40 rounded-lg">
                  ...
                  <div className="flex items-center gap-2.5 p-2 bg-app-surface dark:bg-neutral-950 border border-app-line/80 rounded-lg shadow-[0_2px_8px_rgba(0,0,0,0.01)] transition-all duration-300">
                    <span
                  ...
                  {/* Task 3: Uncompleted */}
                  <div className="flex items-center gap-2.5 p-2 bg-app-surface dark:bg-neutral-950 border border-app-line/80 rounded-lg shadow-[0_2px_8px_rgba(0,0,0,0.01)]">
                    <span
