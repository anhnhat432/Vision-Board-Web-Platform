...
const DEFAULTS: Record<GoalArchetype, ArchetypePlanFullDefaults> = {
  ...
  health_fitness: {
    ...
    weekOneFocus: "Tuần 1 nhẹ: đo mốc hiện tại, kiểm tra kỹ thuật, làm quen nhịp.",
    weekOneExpectedOutput: "3 buổi ngắn đã làm + ghi chú mốc hiện tại (cân, nhịp tim, kỹ thuật).",
    firstAction: {
      standard: "Đo mốc hiện tại trong 24h tới (cân, nhịp tim, hoặc 1 set thử) và ghi lại.",
      lowFeasibility: "Hôm nay đi bộ 10-15 phút và ghi 1 dòng mốc hiện tại. Chỉ cần thế là tuần 1 đã bắt đầu.",
    },
  ...
  career_growth: {
    ...
    weekOneFocus: "Chốt lịch làm sâu + đặt 1 buổi 1:1 với mentor/quản lý.",
    weekOneExpectedOutput: "2 khung làm sâu đã chạy + 1 buổi 1:1 đã họp.",
    firstAction: {
      standard: "Đặt lịch 1 buổi làm sâu 60-90 phút trong 48h tới và gửi tin nhắn xin 1:1 với mentor.",
      lowFeasibility: "Hôm nay chặn 30 phút làm sâu trên lịch và soạn 1 tin nhắn xin 1:1 (chưa cần gửi cũng được).",
    },
    weekOneTacticLoadHint: "balanced",
  ...
  financial_goal: {
    leadIndicatorSuggestions: [
      "Theo dõi chi tiêu 5-10 phút",
      "Chuyển khoản tiết kiệm cố định",
      "Review tiền hằng tuần",
    ],
    milestoneTemplates: {
      week4: "Theo dõi chi tiêu 4 tuần liên tiếp + chuyển khoản tự động đã thiết lập.",
    ...
    weekOneFocus: "Thiết lập theo dõi + tự động hóa tiết kiệm, giữ số tiết kiệm nhẹ tuần đầu.",
    weekOneExpectedOutput: "Hệ thống theo dõi đã chạy + 1 lần chuyển khoản tự động đã thành công.",
    firstAction: {
      standard: "Mở app/sheet theo dõi trong 24h tới và thiết lập 1 lệnh chuyển khoản tiết kiệm tự động.",
  ...
  exam_study: {
    ...
    milestoneTemplates: {
      week4: "Hoàn thành 4 đề thi thử, có mốc hiện tại và đã ưu tiên kỹ năng yếu nhất.",
    ...
    weekOneFocus: "Làm 1 đề thi thử đầy đủ để biết mốc hiện tại thật. Không học lan man.",
    weekOneExpectedOutput: "1 đề thi thử + danh sách lỗi + lịch ôn lặp lại.",
    firstAction: {
      standard: "Lên lịch làm 1 đề thi thử đầy đủ trong 48h tới và in/lưu đề sẵn ngay hôm nay.",
      lowFeasibility: "Hôm nay làm 1 phần nhỏ của đề thi thử (15-20 phút) để biết mốc yếu nhất.",
    },
    weekOneTacticLoadHint: "balanced",
    reviewPrompt: "Điểm thử tuần này so với tuần trước? Kỹ năng nào còn yếu?",
    antiPatterns: [
      "Đặt mục tiêu band/cấp độ cuối mà không có nhịp đề thi thử.",
