import { CalendarDays, ClipboardCheck, Target, Zap, CheckCircle, Flag, Award, Flame } from "lucide-react";
    ...
    <div className="mx-auto max-w-4xl space-y-6 select-none animate-in fade-in duration-300">
      ...
      <section className="relative overflow-hidden rounded-3xl p-[2px] border border-indigo-200/60 dark:border-indigo-900/40 shadow-xl shadow-indigo-50/40 dark:shadow-none bg-gradient-to-tr from-indigo-500/10 via-transparent to-emerald-500/10">
        <div className="rounded-[22px] bg-white dark:bg-slate-900 p-6 sm:p-7 relative z-10">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between border-b border-slate-200/50 dark:border-slate-800/40 pb-5 relative z-10">
            <div>
              <p className="text-[10px] font-extrabold uppercase tracking-[0.2em] text-indigo-650 dark:text-indigo-400 flex items-center gap-1.5">
              ...
              <p className="mt-2 text-xs leading-relaxed text-slate-500 dark:text-slate-400 font-medium">
                Bản tóm tắt lộ trình 12 tuần của bạn đã được đúc kết. Hãy rà soát thật kỹ các cam kết trước khi rung chuông khởi phát chu kỳ mới!
              </p>
            </div>
            <Badge variant="brand" className="inline-flex min-h-10 shrink-0 items-center justify-center px-4.5 py-2 bg-gradient-to-r from-app-accent to-indigo-600 hover:brightness-105 text-white font-extrabold rounded-xl text-xs shadow-md shadow-indigo-500/20">
              Lộ trình 12 tuần
            </Badge>
          </div>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3 relative z-10">
            ...
            <div className="rounded-2xl border border-slate-200/60 dark:border-slate-800/40 bg-slate-50/30 dark:bg-slate-950/10 p-4 hover:scale-[1.01] transition-all duration-300">
              ...
              <p className="mt-3 text-[9px] font-extrabold uppercase tracking-[0.14em] text-slate-450">Mốc chốt Tuần 12</p>
            ...
            <div className="rounded-2xl border border-slate-200/60 dark:border-slate-800/40 bg-slate-50/30 dark:bg-slate-950/10 p-4 hover:scale-[1.01] transition-all duration-300">
              ...
              <p className="mt-3 text-[9px] font-extrabold uppercase tracking-[0.14em] text-slate-450">Chỉ số đo lường (Lag Metric)</p>
              <p className="mt-1.5 text-xs font-extrabold text-indigo-650 dark:text-indigo-400">
            ...
            <div className="rounded-2xl border border-slate-200/60 dark:border-slate-800/40 bg-slate-50/30 dark:bg-slate-950/10 p-4 hover:scale-[1.01] transition-all duration-300">
              ...
              <p className="mt-3 text-[9px] font-extrabold uppercase tracking-[0.14em] text-slate-450">Ngày khởi hành chu kỳ</p>
            ...
            <div className="rounded-2xl border border-slate-200/60 dark:border-slate-800/40 bg-slate-50/30 dark:bg-slate-950/10 p-4 hover:scale-[1.01] transition-all duration-300 sm:col-span-2">
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-[9px] font-extrabold uppercase tracking-[0.14em] text-slate-450">Động lực thôi thúc chính</p>
            ...
            <div className="rounded-2xl border border-slate-200/60 dark:border-slate-800/40 bg-slate-50/30 dark:bg-slate-950/10 p-4 hover:scale-[1.01] transition-all duration-300">
              ...
              <p className="mt-3 text-[9px] font-extrabold uppercase tracking-[0.14em] text-slate-450">Ngày review nhìn lại tuần</p>
      ...
      <section className="relative overflow-hidden rounded-3xl border border-white/20 dark:border-slate-850/40 bg-white/70 dark:bg-slate-900/60 backdrop-blur-xl shadow-2xl p-6 sm:p-7 transition-all duration-300 group select-none">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-200/40 dark:border-slate-800/40 pb-4 relative z-10">
          <div>
            <h4 className="text-base font-extrabold text-slate-800 dark:text-slate-100 flex items-center gap-1.5">
              <CheckCircle className="h-4.5 w-4.5 text-indigo-500 shrink-0 inline-block mr-1" aria-hidden="true" /> Hành động lặp lại cam kết (Lead Indicators)
            </h4>
          ...
          <Badge variant="neutral" className="inline-flex min-h-8 shrink-0 items-center px-3 bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-650 dark:text-slate-350 font-bold rounded-full text-xs">
        ...
        <div className="mt-4 flex gap-3 rounded-2xl border border-indigo-100 dark:border-indigo-950 bg-indigo-500/5 p-4 text-xs leading-relaxed text-slate-500 dark:text-slate-400 font-medium relative z-10">
          <ClipboardCheck className="mt-0.5 h-4.5 w-4.5 shrink-0 text-indigo-650" aria-hidden="true" />
          <p>
            Chỉ số thực thi (Execution Score) hằng tuần sẽ tự động tính toán dựa trên mức độ bạn hoàn thành các hành động này so với cam kết ban đầu. Hãy kiên trì!
          </p>
        </div>
      ...
      <section className="relative overflow-hidden rounded-3xl border border-white/20 dark:border-slate-850/40 bg-white/70 dark:bg-slate-900/60 backdrop-blur-xl shadow-2xl p-6 sm:p-7 transition-all duration-300 group select-none">
        ...
        <h4 className="text-base font-extrabold text-slate-800 dark:text-slate-100 flex items-center gap-1.5 border-b border-slate-200/40 dark:border-slate-800/40 pb-4 relative z-10">
          <CalendarDays className="h-4.5 w-4.5 text-indigo-500 shrink-0 inline-block mr-1" aria-hidden="true" /> Trọng tâm & Hành động đầu tiên
        </h4>
        {week1 ? (
          <div className="mt-4 space-y-4 text-xs leading-relaxed text-slate-500 dark:text-slate-400 font-semibold relative z-10">
            {week1.focus ? (
              <p className="flex items-start gap-1.5">
                ...
                <span>
                  <strong className="text-slate-700 dark:text-slate-200 font-bold">Trọng tâm tuần 1:</strong> {week1.focus}
                </span>
              </p>
            ) : null}
            {week1.expectedOutput ? (
              <p className="flex items-start gap-1.5 whitespace-pre-line">
                ...
                <span>
                  <strong className="text-slate-700 dark:text-slate-200 font-bold">Kết quả dự kiến:</strong> {week1.expectedOutput}
                </span>
              </p>
            ) : null}
            ...
            <div className="mt-5 rounded-2xl border border-indigo-200 dark:border-indigo-900/50 bg-gradient-to-r from-indigo-500/10 to-emerald-500/5 p-4.5 border-dashed flex flex-col sm:flex-row items-center gap-4 justify-between">
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <p className="text-[11px] text-slate-550 dark:text-slate-400 font-semibold mt-0.5">
                    Vào ngày <strong className="text-app-accent font-bold">{formatDateLabel(draft.startDate)}</strong>, hãy hoàn thành: 
                    <span className="block font-extrabold text-indigo-650 dark:text-indigo-400 mt-0.5">👉 {weekOneTasks[0]?.title || repeatedItems[0]?.name || "Hành động lặp lại tuần 1"}</span>
                  </p>
                </div>
              </div>
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2">
              {weekOneTasks.slice(0, 4).map((task) => (
                <div key={task.id} className="rounded-2xl border border-slate-250/50 dark:border-slate-800/50 bg-slate-50/20 dark:bg-slate-950/10 px-4 py-3 hover:scale-[1.01] transition-transform duration-300">
                  <p className="font-bold text-slate-750 dark:text-slate-150 flex items-center gap-1.5">
                    <CheckCircle className="h-4 w-4 text-indigo-500 shrink-0 mt-0.5" />
                    <span>{task.title}</span>
                  </p>
                  <p className="mt-1 text-[9px] text-slate-450 dark:text-slate-400 font-bold">{formatDateLabel(task.scheduledDate)}</p>
                </div>
              ))}
            </div>
          </div>
