    ...
    <div className="space-y-4">
      {shouldShowWeeklyReviewBanner && (
        ...
        >
          <button
            type="button"
            className="inline-flex w-full items-center justify-center rounded-xl bg-app-warm px-4 py-1.5 text-xs font-semibold text-white transition-colors duration-150 hover:bg-app-warm/95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-app-warm/30 sm:w-auto"
          ...
          <button
            type="button"
            className="inline-flex w-full items-center justify-center rounded-xl border border-app-line bg-app-surface px-4 py-1.5 text-xs font-medium text-app-ink transition-colors duration-150 hover:bg-app-bg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-app-warm/30 sm:w-auto"
      ...
      {hasBackendSyncIssue && (
        ...
        >
          ...
          <button
            type="button"
            className="inline-flex w-full items-center justify-center rounded-xl border border-app-line bg-app-surface px-4 py-1.5 text-xs font-medium text-app-ink transition-colors duration-150 hover:bg-app-bg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--color-danger-border)] sm:w-auto"
            onClick={() => handleTabChange("settings")}
          >
            Xem trạng thái sync
          </button>
