      ...
      <section className="rounded-lg border border-app-line bg-app-bg p-3" aria-labelledby="lead-step-hero">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-lg border border-dashed border-app-line bg-app-bg p-3 text-sm font-medium text-app-accent transition-colors duration-150 hover:bg-app-accent-soft disabled:cursor-not-allowed disabled:text-app-ink-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-app-accent/30"
          >
      ...
      <details className="rounded-lg border border-app-line bg-app-surface p-4">
        ...
        <div className="mt-3 grid gap-3 md:grid-cols-2">
          <div className="rounded-lg border border-app-line bg-app-bg p-3">
            <p className="text-xs font-semibold uppercase tracking-[0.14em] text-app-accent">Ví dụ tốt</p>
          ...
          <div className="rounded-lg border border-app-line bg-app-bg p-3">
            <p className="text-xs font-semibold uppercase tracking-[0.14em] text-app-ink-muted">Chưa hợp</p>
            <ul className="mt-2 space-y-1 text-sm leading-6 text-app-ink-soft">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex flex-wrap items-center justify-between gap-3">
                  ...
                  {draft.leadIndicators.length > 2 ? (
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-medium text-app-ink-muted transition-colors duration-150 hover:text-[color:var(--color-danger-fg)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-app-accent/30"
                    >
                ...
                <div className="mt-4 rounded-lg border border-app-line bg-app-bg p-3">
                  <button
                    type="button"
                    className="flex w-full items-center justify-between gap-3 text-left text-sm font-medium text-app-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-app-accent/30"
