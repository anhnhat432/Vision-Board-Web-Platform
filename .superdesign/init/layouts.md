...
This file provides the source code of the main layout components of the application.

## 1. AppSidebar (`src/app/components/root-layout/AppSidebar.tsx`)
        ...
        {user ? (
          ...
          <div className="flex flex-col gap-2">
            <Button
              variant="ghost"
              size="sm"
              className="h-10 w-full rounded-xl bg-app-accent text-sm font-semibold text-white"
            ...
            <Button
              variant="ghost"
              size="sm"
              className="h-10 w-full rounded-xl border border-app-line bg-app-surface text-sm font-semibold text-app-ink"
...
## 2. RootLayout Render Logic (`src/app/components/root-layout/RootLayout.tsx` lines 800-1505)

The root app shell layout handles mobile headers, bottom navigation for mobile, side navigation for desktop, and page route transition wrappers.

Please refer to the source code: [RootLayout.tsx](file:///c:/Users/admin/Downloads/Vision%20Board%20Web%20Platform/src/app/components/root-layout/RootLayout.tsx#L800-L1505) for full rendering implementation details.
