...
const PAGES = [
  ...
  { name: "life-insight", path: "/life-insight" },
  { name: "smart-goal-setup", path: "/smart-goal-setup" },
  { name: "feasibility", path: "/feasibility" },
  { name: "12-week-setup", path: "/12-week-setup" }
];
...
async function run() {
  ...
  for (const pageInfo of PAGES) {
    ...
    await page.goto(url);
    await page.waitForLoadState("networkidle");
    await page.waitForTimeout(1000); // Đợi thêm 1s cho chắc chắn render xong
