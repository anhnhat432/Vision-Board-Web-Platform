...
- Name: ux-ui-upgrade-responsive.spec.ts >> ux-ui-upgrade · responsive · Onboarding (/onboarding) >> viewport 360×800 (mobile) >> layout & touch-target compliance
- Location: e2e\ux-ui-upgrade-responsive.spec.ts:300:9

# Error details

```
Error: Found 2 undersized Touch_Target(s) at 360px on Onboarding:
a "Bỏ qua điều hướng" 142.7×25.6@(-9999,0)
button "Hướng dẫn" 42.0×36.0@(306,44)
