...
- Name: ux-ui-upgrade-responsive.spec.ts >> ux-ui-upgrade · responsive · Dashboard (/) >> viewport 767×900 (mobile) >> layout & touch-target compliance
- Location: e2e\ux-ui-upgrade-responsive.spec.ts:300:9

# Error details

```
Error: Found 28 undersized Touch_Target(s) at 767px on Dashboard:
button "Âm thanh tập trung" 42.0×36.0@(432,14)
button 40.0×40.0@(568,12)
button "Đăng ký" 82.8×40.0@(614,12)
button 40.0×40.0@(703,12)
button "📚 Đọc sách" 93.4×29.4@(24,538)
button "🎧 IELTS 7.0" 93.5×29.4@(123,538)
button "🏋️ Gym" 68.7×29.4@(223,538)
button "💻 Portfolio" 91.6×29.4@(298,538)
button "🎨 1. Tầm nhìn" 236.3×31.4@(29,744)
button "🎯 2. Chuẩn SMART" 236.3×31.4@(265,744)
button "⚡ 3. Việc Today" 236.3×31.4@(502,744)
button 40.0×40.0@(711,844)
a "Dear Our Future" 171.5×32.0@(24,3681)
a 36.0×36.0@(24,3820)
a "Trang chính" 83.8×19.0@(24,3930)
a "Tính năng" 70.6×19.0@(24,3964)
a "Gói & thanh toán" 121.9×19.0@(24,3997)
a "Hỏi đáp thanh toán" 139.0×19.0@(24,4031)
a "Trung tâm trợ giúp" 133.9×19.0@(24,4064)
a "Về Dear Our Future" 137.9×19.0@(24,4161)
a "Liên hệ" 51.8×19.0@(24,4194)
a "Điều khoản dịch vụ" 136.8×19.0@(24,4291)
a "Chính sách bảo mật" 144.8×19.0@(24,4324)
a "Chính sách hoàn tiền" 150.6×19.0@(24,4358)
button "Ẩn lộ trình" 106.3×40.0@(77,821)
button "Để sau" 82.6×40.0@(437,821)
button "Mở Trang chính" 162.8×40.0@(528,821)
button "Close" 32.0×32.0@(671,71)
                        ...
                        - generic:
                          - generic:
                            ...
                            - heading "Thiết lập cuộc sống mơ ước qua kế hoạch 12 tuần bền bỉ" [level=1]:
                              - text: Thiết lập cuộc sống mơ ước qua
                              - text: kế hoạch 12 tuần bền bỉ
                      ...
                      - generic:
                        - generic:
                          ...
                          - heading "Kiến tạo phiên bản rực rỡ nhất của bạn" [level=2]:
                            - text: Kiến tạo phiên bản
                            - text: rực rỡ nhất của bạn
