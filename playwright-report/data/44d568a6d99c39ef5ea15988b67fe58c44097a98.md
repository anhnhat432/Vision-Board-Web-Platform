...
- Name: ux-ui-upgrade-responsive.spec.ts >> ux-ui-upgrade · responsive · Dashboard (/) >> viewport 360×800 (mobile) >> layout & touch-target compliance
- Location: e2e\ux-ui-upgrade-responsive.spec.ts:300:9

# Error details

```
Error: Found 25 undersized Touch_Target(s) at 360px on Dashboard:
button "Âm thanh tập trung" 42.0×36.0@(187,14)
button "Đăng ký" 82.8×40.0@(235,12)
button 19.8×40.0@(324,12)
button "📚 Đọc sách" 93.4×29.4@(16,575)
button "🎧 IELTS 7.0" 93.5×29.4@(115,575)
button "🏋️ Gym" 68.7×29.4@(215,575)
button "💻 Portfolio" 91.6×29.4@(16,610)
button "🎨 1. Tầm nhìn" 106.0×31.4@(21,901)
button 40.0×40.0@(304,744)
a "Dear Our Future" 171.5×32.0@(16,4912)
a 36.0×36.0@(16,5051)
a "Trang chính" 83.8×19.0@(16,5161)
a "Tính năng" 70.6×19.0@(16,5195)
a "Gói & thanh toán" 121.9×19.0@(16,5228)
a "Hỏi đáp thanh toán" 139.0×19.0@(16,5262)
a "Trung tâm trợ giúp" 133.9×19.0@(16,5295)
a "Về Dear Our Future" 137.9×19.0@(16,5392)
a "Liên hệ" 51.8×19.0@(16,5425)
a "Điều khoản dịch vụ" 136.8×19.0@(16,5522)
a "Chính sách bảo mật" 144.8×19.0@(16,5555)
a "Chính sách hoàn tiền" 150.6×19.0@(16,5589)
