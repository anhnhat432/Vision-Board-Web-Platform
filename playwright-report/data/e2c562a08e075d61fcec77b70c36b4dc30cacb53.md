...
- Name: ux-ui-upgrade-responsive.spec.ts >> ux-ui-upgrade · responsive · LifeBalance (/life-balance) >> viewport 360×800 (mobile) >> layout & touch-target compliance
- Location: e2e\ux-ui-upgrade-responsive.spec.ts:300:9

# Error details

```
Error: Found 23 undersized Touch_Target(s) at 360px on LifeBalance:
button "Âm thanh tập trung" 42.0×36.0@(187,14)
button "Đăng ký" 82.8×40.0@(235,12)
button 19.8×40.0@(324,12)
button[role=tab] "Hiện tại" 88.7×35.3@(21,857)
button[role=tab] "Trọng tâm" 134.2×35.3@(114,857)
button[role=tab] "Lịch sử" 84.0×35.3@(252,857)
a "Làm lại khảo sát toàn diện →" 184.3×18.8@(139,2573)
a "Dear Our Future" 171.5×32.0@(16,2822)
a 36.0×36.0@(16,2961)
a "Trang chính" 83.8×19.0@(16,3071)
a "Tính năng" 70.6×19.0@(16,3105)
a "Gói & thanh toán" 121.9×19.0@(16,3138)
a "Hỏi đáp thanh toán" 139.0×19.0@(16,3172)
a "Trung tâm trợ giúp" 133.9×19.0@(16,3206)
a "Về Dear Our Future" 137.9×19.0@(16,3302)
a "Liên hệ" 51.8×19.0@(16,3336)
a "Điều khoản dịch vụ" 136.8×19.0@(16,3432)
a "Chính sách bảo mật" 144.8×19.0@(16,3466)
a "Chính sách hoàn tiền" 150.6×19.0@(16,3499)
button "Ẩn lộ trình" 106.3×40.0@(33,1093)
button "Để sau" 82.6×40.0@(33,1045)
button "Mở Trang chính" 162.8×40.0@(124,1045)
button "Close" 32.0×32.0@(303,65)
