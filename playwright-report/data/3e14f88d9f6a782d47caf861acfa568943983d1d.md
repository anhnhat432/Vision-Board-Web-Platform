...
- Name: ux-ui-upgrade-responsive.spec.ts >> ux-ui-upgrade · responsive · LifeBalance (/life-balance) >> viewport 767×900 (mobile) >> layout & touch-target compliance
- Location: e2e\ux-ui-upgrade-responsive.spec.ts:300:9

# Error details

```
Error: Found 24 undersized Touch_Target(s) at 767px on LifeBalance:
button "Âm thanh tập trung" 42.0×36.0@(394,14)
button 40.0×40.0@(568,12)
button "Đăng ký" 82.8×40.0@(614,12)
button 40.0×40.0@(703,12)
button[role=tab] "Hiện tại" 88.7×35.3@(29,504)
button[role=tab] "Trọng tâm" 134.2×35.3@(122,504)
button[role=tab] "Lịch sử" 84.0×35.3@(260,504)
a "Làm lại khảo sát toàn diện →" 184.3×18.8@(538,1867)
a "Dear Our Future" 171.5×32.0@(24,2116)
a 36.0×36.0@(24,2256)
a "Trang chính" 83.8×19.0@(24,2366)
a "Tính năng" 70.6×19.0@(24,2399)
a "Gói & thanh toán" 121.9×19.0@(24,2433)
a "Hỏi đáp thanh toán" 139.0×19.0@(24,2467)
a "Trung tâm trợ giúp" 133.9×19.0@(24,2500)
a "Về Dear Our Future" 137.9×19.0@(24,2597)
a "Liên hệ" 51.8×19.0@(24,2630)
a "Điều khoản dịch vụ" 136.8×19.0@(24,2727)
a "Chính sách bảo mật" 144.8×19.0@(24,2760)
a "Chính sách hoàn tiền" 150.6×19.0@(24,2794)
