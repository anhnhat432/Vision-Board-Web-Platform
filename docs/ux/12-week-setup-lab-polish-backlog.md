...
| -------- | ------------- | --------------- | ------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------- | -------------------------------- |
| P0       | UX copy       | Step 1          | Làm rõ “Kết quả cuối 12 tuần” là đích đến sau 12 tuần, không phải task hằng ngày.                                  | Người test hiểu đúng Step 1 ngay trong lần đọc đầu; không còn đọc nhầm thành hoạt động hằng ngày.           | **Must fix**                     |
| P0       | flow clarity  | Step 4          | Khóa rõ sau khi lưu sẽ sang weekly execution/Hôm nay.                                                              | Người test biết chính xác bước tiếp theo sau khi bấm lưu; không còn phải đoán.                              | **Must fix**                     |
| P0       | UX copy       | Step 4          | Làm rõ scorecard/điểm thực thi là điểm theo dõi việc lặp lại, không phải điểm chung chung.                         | User hiểu mục đích scorecard trước khi lưu; không nhầm với điểm đánh giá tổng quát.                         | **Must fix**                     |
| P1       | UX copy       | Step 2          | Giảm độ nặng khái niệm của phần phân biệt “Việc lặp lại” và “Chỉ số kết quả”.                                      | Người test phân biệt được 2 lớp dữ liệu mà không cần giải thích lại nhiều lần.                              | **Must fix**                     |
| P1       | UX copy       | Step 3          | Viết lại các thuật ngữ như “Mức tải tuần đầu”, “Quỹ thời gian”, “Ngày nhìn lại tuần” theo ngôn ngữ đời thường hơn. | User ít quen productivity framework hiểu được các trường mà không phải dịch lại sang ngôn ngữ nội bộ.       | **Must fix**                     |
...
| P2       | test coverage | Step 1          | Bổ sung kiểm tra checklist/field order nếu muốn giữ lab làm ứng viên route chính.                                  | Có test/QA note xác nhận thứ tự field và label ở Step 1 khớp checklist.                                     | **Must fix**                     |
